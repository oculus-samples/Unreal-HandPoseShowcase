...
#include "Engine/World.h"            // Para UWorld e SpawnActor
#include "GameFramework/Actor.h"     // Alguns detalhes de AActor
#include "Engine/EngineTypes.h"      // Para ESpawnActorCollisionHandlingMethod, ECollisionChannel, etc.
