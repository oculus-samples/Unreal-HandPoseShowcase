...
FRotator UHandPoseRecognizer::GetWristRotator(FQuat ComponentQuat)
{
	...
	// Use GameplayStatics para pegar o PlayerController de forma segura
	...
	const FRotator ComponentRotationToCamera =
		PlayerController->PlayerCameraManager->GetTransform()
		.InverseTransformRotation(ComponentQuat).Rotator();
