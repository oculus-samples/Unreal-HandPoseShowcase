...
#include "HandRecognitionFunctionLibrary.h"
#include "EngineGlobals.h"            // Declara extern UEngine* GEngine
#include "Engine/Engine.h"            // Declara UEngine (pode ainda dar warning de "monolithic")
#include "Engine/EngineBaseTypes.h"   // Para EGetWorldErrorMode
#include "Engine/LatentActionManager.h" // Para FLatentActionManager
#include "Engine/World.h"            // Para UWorld
#include "LatentActions.h"           // Se precisar de FPendingLatentAction etc.
